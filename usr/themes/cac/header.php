...
<head>
    ...
    <link href='https://fonts.googleapis.com/css?family=PT+Serif:400,400italic|Source+Sans+Pro:400,700,400italic,700italic,300,300italic|Raleway:400,500,700,300|Raleway+Dots' rel='stylesheet' type='text/css'>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="main-navigation pull-right">
                    ...
                    <div class="responsive-navigation visible-sm visible-xs"><a href="#nogo" class="menu-toggle-btn"><i class="fa fa-bars"></i></a></div> <!-- /responsive_navigation -->
                </div> <!-- /.main-navigation -->
            </div> <!-- /.col-md-12 -->
        </div>
    </div>
